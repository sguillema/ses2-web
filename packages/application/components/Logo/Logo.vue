  ...
  <div class="logo" @click="handleClick">
    ...
    >
      ...
      <g fill="none" fill-rule="evenodd">
        ...
        <path
          class="logo__fill"
          d="M11.92 22.994l-1.455-1.457-1.91 1.912 1.947 1.95a2.005 2.005 0 0 0 2.838 0l1.946-1.949-1.91-1.913-1.456 1.457m.456-3.37l1.912 1.913 1.91-1.912-1.911-1.913-1.91 1.912m-4.278-.454l-1.455-1.457-1.91 1.912 1.946 1.948a2.006 2.006 0 0 0 2.838 0l6.68-6.685-1.911-1.913-6.188 6.194m2.548-16.517L8.1.1 5.551 2.65 8.1 5.202l2.548-2.55"
          fill="#0A0A08"
        />
        <path
          class="logo__fill"
          d="M4.92 8.457h1.827v3.62a2.659 2.659 0 0 1 2.703 0v-3.62h1.828l1.197 1.198 2.548-2.55-2.548-2.55-1.197 1.198H4.92L3.723 4.555l-2.548 2.55 2.548 2.55L4.92 8.457"
          fill="#0A0A08"
        />
      </g>
    </svg>
